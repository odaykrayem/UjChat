...
import com.example.ujchat.Chat.ChatListAdapter;
import com.example.ujchat.User.UserObject;
...
import com.example.ujchat.Chat.ChatObject;

import com.onesignal.OneSignal;
/**
 * Fresco is a powerful system for displaying images in Android applications.
 * Fresco takes care of image loading and display, so you don't have to.
 * It will load images from the network, local storage,
 * or local resources, and display a placeholder until the image has arrived
 */
